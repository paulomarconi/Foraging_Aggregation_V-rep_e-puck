...
%------------------------------------------------------------------------------------------
\title{\LARGE \bf Simple Foraging and Random Aggregation Strategy for swarm robotics without communication - ACS6121 2018/19}
...
\begin{table}[!ht]
	...
	\scalebox{1}{
		\begin{tabular}{c|c|c|c}
			...
			\textbf{ob}stacle $\nexists$ &   \textbf{R}ebound   &   \bf{A}ggregation   &       -        \\
...
The Unicycle model in \figref{fig:ePuck}a \cite{Ghommam2008} is used to control the angular velocities of the right and left wheels, $v_r$ and $v_l$, which are written as follows,
...
\section{APPENDIX}
\lstinputlisting[language={[5.2]Lua},caption={},label={cod:vrep},escapechar=|]{vrep.txt}
